...
<body style="margin-top: 0px;">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active"> 
          <a class="nav-link"><?php echo "<h5> ".$this->session->userdata('cos_name').'</h5>' ; ?></a>  
      </li>
      <li class="nav-item active">
  ...
  <a class="nav-link"><h5>Eshop</h5></a>
      ...
      <li class="nav-item">
        <h5><a class="nav-link" href="<?php echo base_url(); ?>index">Home</a></h5>
      </li>
      <li class="nav-item">
        <h5><a class="nav-link" href="<?php echo base_url(); ?>cart">My Cart</a></h5>
      </li>
         <!--<li class="nav-item">
