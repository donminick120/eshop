...
<div class="gallery" style="width: 180px;height: 400px;">
  ...
  <a href="<?php echo base_url('/products/'.$product['id']); ?>">

    <img style="height: 170px;" src="<?php echo base_url(); ?>assets/image/upload/<?php echo $product['upload-photo'];?>" alt="<?php echo $product['title']; ?>" >
  </a>
  <div class="desc"><?php echo word_limiter($product['description'],5); ?></div>

  <p>Price: <?php echo $product['price']; ?></p><br/>



<?php echo form_open('/products/'.$product['id']); ?>
